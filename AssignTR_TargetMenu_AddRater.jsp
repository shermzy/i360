	...
	{ 
   		for(int i=0; i<chkUser.length; i++)
		{
			...
			for(int j=0; j<relation.length; j++)
			{
				...
				System.out.println("IT IS ADDED " + isAdded);
				System.out.println("SurveyID = " + CE_Survey.getSurvey_ID() +  "selected target= " + assignTR.get_selectedTargetID() + "RaterCode= " + RaterCode + "raterID =" +  raterID);
				if (isAdded)
				{					
					count++;%>				
				<% }
...
%>
	<script>
		alert("complete");
		window.location.href = "AssignTarget_Rater.jsp";
	</script>
<%
}
