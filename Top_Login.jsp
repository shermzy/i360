...
try {
	System.out.println("user PK:"+logchk.getPKUser());
	System.out.println("UserInfo[2]:"+logchk.getPKUser());
	System.out.println("UserInfo[11]:"+logchk.getPKUser());
	System.out.println("UserInfo[10]:"+logchk.getPKUser());
