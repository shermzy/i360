...
function confirmEdit(form, field) {	
	...
	if(value)
	{		
		var myWindow=window.open('EditCompetency.jsp','windowRef','scrollbars=no, width=650, height=550');
...
<input type="button" name="Delete" value="<%= trans.tslt("Delete") %>"  onclick = "confirmDelete(this.form, this.form.checkComp)">
</form>
<% } %>
