...
<jsp:useBean id="RDRC" class="CP_Classes.Report_DistributionOfRatingByCompetency" scope="session"/>
...
function proceed(form,field){
	form.action="Report_DistributionOfRatingByCompetency.jsp?proceed="+field.value;
	form.method="post";
	form.submit();
}
</script>
...
if(request.getParameter("btnPreview") != null)
{
	...
	if(RDRC.checkPCAllGenerated(SurveyID)){
 		RDRC.write(SurveyID,file_name);	
		...
		response.addHeader ("Content-Disposition", "attachment;filename=\"Distribution of Rating Report.xls\"");
		...
		%><script>
		alert("Individual report for the selected report haven't been generated, please generate it first");</script>
		<%
	}
	//read the file name.
...
%>
<form name="Report_DistributionOfRatingByCompetency" action="Report_DistributionOfRatingByCompetency.jsp" method="post">
<table border="0" width="483" cellspacing="0" cellpadding="0">
	<tr>
		<td><b>
		<font face="Arial" size="2" color="#000080"><%=trans.tslt("Ratings Distribution Report")%></font></b></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
