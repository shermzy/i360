...
<%
	...
	String query1 ="SELECT DISTINCT b.TargetLoginID, PKUser, NameSequence, ";
	...
	query1 += "FROM tblSurvey a, tblAssignment b, [User] c, tblOrganization d WHERE c.FKOrganization = d.PKOrganization AND a.SurveyID = b.SurveyID AND b.TargetLoginID=c.PKUser AND a.SurveyID ="+CE_Survey.getSurvey_ID();	
...
%>
	<option value=<%=TargetID%> selected> <%=rs_Target.getString("FullName")%></option>
<%
	}%>
</select></td>
	</tr>
