...
public class _surveykeybehaviour__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    synchronized (pageContext.getSession()) {
      SKB = (CP_Classes.SurveyKB) pageContext.getSession().getAttribute("SKB");
      if (SKB == null) {
        SKB = new CP_Classes.SurveyKB();
        pageContext.getSession().setAttribute("SKB", SKB);
      }
    }
    ...
    out.print((trans.tslt("Delete Assigned Key Behaviour")));
...
if(CE_Survey.getCompetencyLevel() != 1)
{
    ...
    out.print((trans.tslt("Your current level of survey is Competency level")));
...
if(SCluster.getUseCluster(CE_Survey.getSurvey_ID())==false){ //not using cluster
    ...
    out.print((trans.tslt("Key Behaviour Description")));
    ...
    out.print((trans.tslt("Add Key Behaviour")));
...
/***************************** END OF PART USING CLUSTER ************************************************/
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("SurveyKeyBehaviour.jsp"), -1021909324274018939L, false);
    _caucho_depends.add(depend);
  ...
  static {
    ...
    _jsp_string30 = "\r\n					".toCharArray();
    _jsp_string57 = " Pacific Century Consulting Pte Ltd. All Rights Reserved.\r\n		</font>\r\n		</td>\r\n		\r\n	</tr>\r\n		\r\n</table>\r\n\r\n</body>\r\n</html>".toCharArray();
    _jsp_string23 = "\r\n<div style='width:610px; height:256px; z-index:1; overflow:auto'>  \r\n		<table border=\"1\" width=\"610\" bordercolor=\"#3399FF\" bgcolor=\"#FFFFCC\">\r\n		<tr>\r\n				<td colspan=\"3\" bgcolor=\"#000080\">\r\n				<p align=\"center\"><span style=\"font-weight: 700\">\r\n				<font face=\"Arial\" color=\"#FFFFFF\" size=\"2\">".toCharArray();
    _jsp_string49 = "    				<option value = ".toCharArray();
    _jsp_string43 = "\r\n<div style='width:610px; height:256px; z-index:1; overflow:auto'> \r\n	<table>\r\n		<tr><td>".toCharArray();
    ...
    _jsp_string50 = "  			\r\n  		</select>\r\n  		</td>\r\n  		</tr>\r\n  	</table> <br>\r\n  	\r\n		<table border=\"1\" width=\"610\" bordercolor=\"#3399FF\" bgcolor=\"#FFFFCC\">\r\n		<tr>\r\n				<td colspan=\"3\" bgcolor=\"#000080\">\r\n				<p align=\"center\"><span style=\"font-weight: 700\">\r\n				<font face=\"Arial\" color=\"#FFFFFF\" size=\"2\">".toCharArray();
    _jsp_string42 = "\" name=\"btnNext\" style=\"float: right\" onclick=\"goNext()\"></td>\r\n\r\n	</tr>\r\n</table>\r\n".toCharArray();
    ...
    _jsp_string31 = ".\r\n			".toCharArray();
    _jsp_string36 = "\" name=\"btnBack\" style=\"float: left\" onclick=\"goBack()\"></td>\r\n		".toCharArray();
    _jsp_string37 = "\r\n			<td width=\"26%\">\r\n			<input type=\"button\" value=\"".toCharArray();
    _jsp_string47 = " selected>".toCharArray();
    _jsp_string53 = "\r\n<p></p>\r\n\r\n\r\n".toCharArray();
    _jsp_string3 = "\r\n\r\n\r\n\r\n<html>\r\n<head>\r\n<meta http-equiv=\"Content-Type\" content=\"text/html\">\r\n\r\n".toCharArray();
    _jsp_string6 = "\");\r\n	\r\n	isValid = 0;\r\n\r\n}\r\n\r\n//Edited by Xuehai 02 Jun 2011. Remove 'void'. Enable to run on different browers like Chrome&Firefox.\r\n//void function remove(form, field)\r\nfunction remove(form, field)\r\n{\r\n	if(check(field))\r\n	{\r\n		if(confirm(\"".toCharArray();
    _jsp_string51 = "\" name=\"btnAdd\" style=\"float: right\" onclick=\"windowOpenCluster(this.form)\"></td>\r\n			<td width=\"24%\">\r\n			<input type=\"button\" value=\"".toCharArray();
    ...
    _jsp_string9 = "\r\n	<script>\r\n	alert(\"".toCharArray();
    _jsp_string39 = "\" name=\"btnDel\" style=\"float: right\" onclick=\"remove(this.form, this.form.chkDel)\"></td>\r\n			".toCharArray();
    _jsp_string33 = "</FONT></td>\r\n				<td width=\"72%\" align=\"left\">\r\n				<font face=\"Arial\" size=\"2\">".toCharArray();
    ...
    _jsp_string38 = "\" name=\"btnAdd\" style=\"float: right\" onclick=\"windowOpen()\"></td>\r\n			<td width=\"24%\">\r\n			<input type=\"button\" value=\"".toCharArray();
    _jsp_string52 = "\r\n\r\n</form>\r\n".toCharArray();
    ...
    _jsp_string46 = "					<option value = ".toCharArray();
