...
public class _sendnominationemail__jsp extends com.caucho.jsp.JavaPage
{
...
//limit the upload attachment size to be 1MB maximum and only five types of file can be accepted: *.doc,*.docx,*.xls,*.xlsx,*.pdf
    ...
    if (upBean == null) {
      ...
      out.write(_jsp_string3, 0, _jsp_string3.length);
      upBean.setFilesizelimit(1048576);
      out.write(_jsp_string3, 0, _jsp_string3.length);
      upBean.setWhitelist("*.doc,*.docx,*.xls,*.xlsx,*.pdf");
      out.write(_jsp_string2, 0, _jsp_string2.length);
    }
...
if(request.getParameter("preview") != null)
{
    ...
    out.print((trans.tslt("Sorry, only DOC, EXCEL and PDF files can be accepted, within maximum size 1MB.")));
    ...
    out.print((trans.tslt("Sorry, only DOC, EXCEL and PDF files can be accepted, within maximum size 1M.")));
    ...
    out.print(((sFileName==null?"":sFileName)));
...
if((request.getParameter("emailUser") != null) 
    ...
    out.print((trans.tslt("Send Nomination Emails")));
...
if((mrequest==null?request.getParameter("selSurvey"):mrequest.getParameter("selSurvey")) != null){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("SendNominationEmail.jsp"), 8736869577499686202L, false);
    _caucho_depends.add(depend);
  ...
  static {
    ...
    _jsp_string14 = " before sending ')</script>  \r\n						".toCharArray();
    ...
    _jsp_string11 = "\r\n						<script>\r\n	                        alert('".toCharArray();
    _jsp_string13 = "\r\n							<script>alert('You need to create a normination notification template ".toCharArray();
    ...
    _jsp_string25 = "Email sent! But error(s) occurred. Please refer to <a href='SentFailedEmail.jsp'>View Sent Failed Emails</a>".toCharArray();
    _jsp_string41 = "\r\n			\r\n			<input type=\"checkbox\" name=\"chkReminder\" value=\"0\">\r\n		".toCharArray();
    _jsp_string35 = "\r\n		<select size=\"1\" name=\"selOrg\" onchange=\"proceed(this.form,this.form.selOrg)\">\r\n		<option value=".toCharArray();
    _jsp_string43 = ":</font>\r\n    	<select size=\"1\" name=\"selSup\">\r\n    	<option selected value=' '>&nbsp</option>\r\n".toCharArray();
    _jsp_string18 = ");\r\n						url.push('&file=');\r\n						url.push(escape('".toCharArray();
    _jsp_string26 = "\r\n		<script>alert('You need to create a normination notification template ".toCharArray();
    _jsp_string19 = "'));\r\n						//window.location.href =\"SendNominationEmail.jsp?emailUser=1&SupID=\" + ".toCharArray();
    ...
    _jsp_string27 = " before sending ')</script>  \r\n	".toCharArray();
    _jsp_string22 = ";\r\n						window.location.href=url.join('');\r\n					}\r\n					</script>\r\n					".toCharArray();
    _jsp_string32 = "\r\n				<option value=".toCharArray();
    _jsp_string17 = ");\r\n						url.push('&Rem=');\r\n						url.push(".toCharArray();
    _jsp_string33 = " selected>".toCharArray();
    _jsp_string51 = "\r\n<p></p>\r\n\r\n\r\n".toCharArray();
    ...
    _jsp_string20 = " + \"&SurveyID=\" + ".toCharArray();
    ...
    _jsp_string2 = "\r\n".toCharArray();
    _jsp_string45 = "<script>alert(\"No Supervisor available\")</script></p>".toCharArray();
    _jsp_string10 = " before sending ')</script>  \r\n".toCharArray();
    _jsp_string6 = " <font size=\"2\">\r\n   \r\n	<script>\r\n	parent.location.href = \"index.jsp\";\r\n	</script>\r\n".toCharArray();
    _jsp_string1 = "                   \r\n".toCharArray();
    _jsp_string0 = "   \r\n".toCharArray();
    _jsp_string9 = "\r\n 					<script>alert('You need to create a normination notification template ".toCharArray();
    _jsp_string23 = "\r\n			<script language = javascript>\r\n				//Edited by Xuehai 20 May 2011, change 'Supervisor' to 'Target'.\r\n				//alert(\"Please select Supervisor\");\r\n				alert(\"Please select Target\");\r\n			</script>\r\n			".toCharArray();
    _jsp_string24 = "Email sent!".toCharArray();
    _jsp_string8 = "');\r\n                    </script>\r\n".toCharArray();
