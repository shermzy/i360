...
public class _report_0distributionofratingbycompetency__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    CP_Classes.Report_DistributionOfRatingByCompetency RDRC;
    synchronized (pageContext.getSession()) {
      RDRC = (CP_Classes.Report_DistributionOfRatingByCompetency) pageContext.getSession().getAttribute("RDRC");
      if (RDRC == null) {
        RDRC = new CP_Classes.Report_DistributionOfRatingByCompetency();
        pageContext.getSession().setAttribute("RDRC", RDRC);
      }
    }
    out.write(_jsp_string2, 0, _jsp_string2.length);
...
if(request.getParameter("btnPreview") != null)
{
    ...
    out.print((trans.tslt("Ratings Distribution Report")));
...
// Mark Oei 09 Mar 2010
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("Report_DistributionOfRatingByCompetency.jsp"), 7998290478941692963L, false);
    _caucho_depends.add(depend);
  ...
  static {
    ...
    _jsp_string23 = "\" name=\"btnPreview\" style=\"float: left\" disabled>\r\n".toCharArray();
    _jsp_string22 = "\" name=\"btnPreview\" style=\"float: left\">\r\n".toCharArray();
