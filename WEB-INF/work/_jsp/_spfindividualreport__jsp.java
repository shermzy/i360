...
public class _spfindividualreport__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    out.write(_jsp_string3, 0, _jsp_string3.length);
    CP_Classes.SPFIndividualReport ExcelIndividualSPF;
    synchronized (pageContext.getSession()) {
      ExcelIndividualSPF = (CP_Classes.SPFIndividualReport) pageContext.getSession().getAttribute("ExcelIndividualSPF");
      if (ExcelIndividualSPF == null) {
        ExcelIndividualSPF = new CP_Classes.SPFIndividualReport();
        pageContext.getSession().setAttribute("ExcelIndividualSPF", ExcelIndividualSPF);
      }
    }
    out.write(_jsp_string3, 0, _jsp_string3.length);
...
// Mark Oei 09 Mar 2010
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("SPFIndividualReport.jsp"), 7909665227882044022L, false);
    _caucho_depends.add(depend);
