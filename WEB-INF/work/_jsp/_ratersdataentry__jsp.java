...
public class _ratersdataentry__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    out.write(_jsp_string2, 0, _jsp_string2.length);
    CP_Classes.SurveyResult S;
    synchronized (pageContext.getSession()) {
      S = (CP_Classes.SurveyResult) pageContext.getSession().getAttribute("S");
      if (S == null) {
        S = new CP_Classes.SurveyResult();
        pageContext.getSession().setAttribute("S", S);
      }
    }
    out.write(_jsp_string2, 0, _jsp_string2.length);
...
/*-------------------------------------------------------------------end login modification 1--------------------------------------*/
    ...
    out.print((trans.tslt("Select the survey, group, target, and rater's name")));
    out.write(_jsp_string9, 0, _jsp_string9.length);
    out.print((trans.tslt("Click on Open Questionnaire to open the questionnaire on screen")));
    out.write(_jsp_string9, 0, _jsp_string9.length);
    out.print((trans.tslt("To Export Questionnaire in excel format, click on Export")));
    out.write(_jsp_string9, 0, _jsp_string9.length);
    out.print((trans.tslt("To Import Questionnaire, click on Import, then browse for the excel file located in the computer")));
    ...
    out.print((trans.tslt("Rating already exist, do you want to overwrite the existing rating input")));
    ...
    out.print((trans.tslt("Rating completed. Please proceed to process result if you wish view the rater''s input imported")));
    ...
    out.write(_jsp_string22, 0, _jsp_string22.length);
    out.print((trans.tslt("Rating completed")));
    out.write(_jsp_string23, 0, _jsp_string23.length);
...
//System.out.println("\n------------------------------------------------------------------------------------------------");
    ...
    out.print((trans.tslt("No comments included. Do you want to set the Questionnaire complete status to finish")));
    out.write(_jsp_string29, 0, _jsp_string29.length);
    out.print((trans.tslt("Import successful")));
    out.write(_jsp_string30, 0, _jsp_string30.length);
    				
						} else {		
    out.write(_jsp_string31, 0, _jsp_string31.length);
    out.print((trans.tslt("Do you want to set the Questionnaire complete status to finish ")));
    ...
    out.print((trans.tslt("Rating updated. Please proceed to process result if you wish view the rater's input imported")));
    ...
    out.print((trans.tslt("Rating updated")));
    out.write(_jsp_string34, 0, _jsp_string34.length);
    ...
    out.print((trans.tslt("Rater's Name")));
    ...
    out.print((trans.tslt("Open Questionnaire")));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("RatersDataEntry.jsp"), -2124174975163508953L, false);
    _caucho_depends.add(depend);
