...
public class _login__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    pageContext.forward("OrganizationList.jsp");if (true) return;
    ...
    out.print(( trans.tslt("3-Sixty Profiler is a thoroughly researched, well proven expert application for") ));
    out.write(_jsp_string8, 0, _jsp_string8.length);
    out.print(( trans.tslt("managing and analysing multi-rater feedback implementation. Its resulting outputs can") ));
    out.write(_jsp_string8, 0, _jsp_string8.length);
    out.print(( trans.tslt("be used as input for development, succession management, performance appraisal") ));
    out.write(_jsp_string9, 0, _jsp_string9.length);
    out.print(( trans.tslt("performance feedback, training analysis, potential assessment etc") ));
    out.write(_jsp_string10, 0, _jsp_string10.length);
    out.print(( trans.tslt("As an administrator, you will be expected to") ));
    out.write(_jsp_string11, 0, _jsp_string11.length);
    out.print(( trans.tslt("Set up the user database") ));
    out.write(_jsp_string12, 0, _jsp_string12.length);
    out.print(( trans.tslt("Set up 3-Sixty Profiling surveys") ));
    out.write(_jsp_string12, 0, _jsp_string12.length);
    out.print(( trans.tslt("Assign surveys to respondents") ));
    out.write(_jsp_string12, 0, _jsp_string12.length);
    out.print(( trans.tslt("Process data collected") ));
    out.write(_jsp_string12, 0, _jsp_string12.length);
    out.print(( trans.tslt("Generate reports") ));
    out.write(_jsp_string13, 0, _jsp_string13.length);
    out.print(( trans.tslt("Step by step Guide") ));
    out.write(_jsp_string14, 0, _jsp_string14.length);
    out.print(( trans.tslt("Click if accessing first time or need help") ));
    out.write(_jsp_string15, 0, _jsp_string15.length);
    
					if(logchk.getCompany() == 1) //PCC, Might need to do some modification if it's consulting company
					{
    out.write(_jsp_string16, 0, _jsp_string16.length);
    out.print(( trans.tslt("Accessing first time as an organisation") ));
    out.write(_jsp_string17, 0, _jsp_string17.length);
    }
    out.write(_jsp_string18, 0, _jsp_string18.length);
    out.print(( trans.tslt("Setting up a new survey") ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("Login.jsp"), 6927857937946900341L, false);
    _caucho_depends.add(depend);
  ...
  static {
    ...
    _jsp_string1 = "\r\n".toCharArray();
    _jsp_string0 = "  \r\n".toCharArray();
    _jsp_string27 = " Pacific Century Consulting Pte Ltd. All Rights Reserved.\r\n		</font>\r\n		</td>\r\n		\r\n	</tr>\r\n		\r\n</table>\r\n\r\n\r\n	</body>\r\n	</html>".toCharArray();
    _jsp_string15 = ").</font></td></tr><tr>\r\n				<td>\r\n				<ul>\r\n					".toCharArray();
    _jsp_string2 = "\r\n\r\n<html>\r\n<head>\r\n<meta http-equiv=\"Content-Type\" content=\"text/html\">\r\n\r\n".toCharArray();
    _jsp_string24 = "\r\n\r\n".toCharArray();
    _jsp_string13 = "</li>\r\n		</ul>\r\n		</table>\r\n	\r\n		<table border=\"0\" width=\"100%\">\r\n			<tr>\r\n				<td><font size=\"2\" face=\"Arial\"><b>".toCharArray();
  }
}
