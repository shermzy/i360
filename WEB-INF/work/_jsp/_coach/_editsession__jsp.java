...
public class _editsession__jsp extends com.caucho.jsp.JavaPage
{
  ...
  { 
    ...
    out.print((CoachSession.getSelectedSession(LoginStatus.getSelectedSession()).getName()));
    out.write(_jsp_string7, 0, _jsp_string7.length);
    out.print((CoachSession.getSelectedSession(LoginStatus.getSelectedSession()).getDescription()));
    out.write(_jsp_string8, 0, _jsp_string8.length);
    out.print((CoachSession.getSelectedSession(LoginStatus.getSelectedSession()).getSessionMax()));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("Coach/EditSession.jsp"), -5868420378064861752L, false);
    _caucho_depends.add(depend);
  }
