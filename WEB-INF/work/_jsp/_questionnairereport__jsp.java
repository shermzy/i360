...
import CP_Classes.QuestionnaireReport;
import CP_Classes.vo.*;

public class _questionnairereport__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    CP_Classes.ExcelQuestionnaire ExcelQuestionnaire;
    synchronized (pageContext.getSession()) {
      ExcelQuestionnaire = (CP_Classes.ExcelQuestionnaire) pageContext.getSession().getAttribute("ExcelQuestionnaire");
      if (ExcelQuestionnaire == null) {
        ExcelQuestionnaire = new CP_Classes.ExcelQuestionnaire();
        pageContext.getSession().setAttribute("ExcelQuestionnaire", ExcelQuestionnaire);
      }
    }
    out.write(_jsp_string4, 0, _jsp_string4.length);
...
// Mark Oei 09 Mar 2010 
    ...
    out.print((trans.tslt("Questionnaire Report")));
 ...
 */    	
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("QuestionnaireReport.jsp"), -1559939593738840624L, false);
    _caucho_depends.add(depend);
  ...
  static {
    ...
    _jsp_string14 = "\r\n				<option value=".toCharArray();
    _jsp_string55 = "\" onclick = \"return confirmOpen(this.form, this.form.raterName.options[raterName.selectedIndex].value)\">\r\n".toCharArray();
    _jsp_string56 = "\" onclick = \"return confirmOpen(this.form, this.form.raterName.options[raterName.selectedIndex].value)\" disabled>\r\n".toCharArray();
    ...
    _jsp_string23 = "\r\n	  ".toCharArray();
    _jsp_string51 = "\r\n    		<script>setOutputOption(document.QuestionnaireReport.chkOutputOption,".toCharArray();
    ...
    _jsp_string47 = "\r\n	  <option value = ".toCharArray();
    _jsp_string31 = "    		<option value = ".toCharArray();
    _jsp_string28 = "\r\n          ".toCharArray();
    _jsp_string1 = "\r\n\r\n</head>\r\n\r\n<body>\r\n\r\n".toCharArray();
    ...
    _jsp_string44 = "\r\n      </select></td>\r\n    </tr>\r\n    \r\n    <tr>\r\n      <td bordercolor=\"#FFFFCC\">&nbsp;</td>\r\n      <td bordercolor=\"#FFFFCC\">&nbsp;</td>\r\n      <td bordercolor=\"#FFFFCC\">&nbsp;</td>\r\n    </tr>\r\n    \r\n    ".toCharArray();
    _jsp_string54 = "\r\n	   	<input type=\"button\" style=\"float: center\" name=\"btnOpen\" value=\"".toCharArray();
