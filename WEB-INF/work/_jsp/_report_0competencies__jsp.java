...
public class _report_0competencies__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    CP_Classes.Report_ListOfCompetencies Rpt1;
    synchronized (pageContext.getSession()) {
      Rpt1 = (CP_Classes.Report_ListOfCompetencies) pageContext.getSession().getAttribute("Rpt1");
      if (Rpt1 == null) {
        Rpt1 = new CP_Classes.Report_ListOfCompetencies();
        pageContext.getSession().setAttribute("Rpt1", Rpt1);
      }
    }
...
if(request.getParameter("btnPreview") != null)
{
    ...
    out.print((trans.tslt("Competency Report")));
...
// Mark Oei 09 Mar 2010
    ...
    out.print((trans.tslt("List of All Competencies")));
    out.write(_jsp_string16, 0, _jsp_string16.length);
    out.print((trans.tslt("List of All Competencies with Definitions")));
    out.write(_jsp_string17, 0, _jsp_string17.length);
    out.print((trans.tslt("List of All Competencies with Definitions and Key Behaviours")));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("Report_Competencies.jsp"), -2096373932776864946L, false);
    _caucho_depends.add(depend);
  ...
  static {
    ...
    _jsp_string2 = "\r\n".toCharArray();
    _jsp_string21 = "\" name=\"btnPreview\" style=\"float: right\" disabled>\r\n".toCharArray();
    _jsp_string20 = "\" name=\"btnPreview\" style=\"float: right\">\r\n".toCharArray();
