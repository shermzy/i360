...
public class _report_0raterinput_0target_0spf__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    CP_Classes.Report_RaterInputForTarget_SPF Rpt6sSPF;
    synchronized (pageContext.getSession()) {
      Rpt6sSPF = (CP_Classes.Report_RaterInputForTarget_SPF) pageContext.getSession().getAttribute("Rpt6sSPF");
      if (Rpt6sSPF == null) {
        Rpt6sSPF = new CP_Classes.Report_RaterInputForTarget_SPF();
        pageContext.getSession().setAttribute("Rpt6sSPF", Rpt6sSPF);
      }
    }
    out.write(_jsp_string1, 0, _jsp_string1.length);
...
if(request.getParameter("btnPreview") != null)
{
	...
	Rpt6sSPF.AllRaters(CE_Survey.getSurvey_ID(), TargetID, logchk.getPKUser(), file_name);
    ...
    out.print((trans.tslt("SPF Summary Report")));
...
// Mark Oei 09 Mar 2010
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("Report_RaterInput_Target_SPF.jsp"), -5862118162819375507L, false);
    _caucho_depends.add(depend);
  ...
  static {
    ...
    _jsp_string35 = " Pacific Century Consulting Pte Ltd. All Rights Reserved.\r\n		</font>\r\n		</td>\r\n		\r\n	</tr>\r\n		\r\n</table>\r\n\r\n	</tr>\r\n</table>\r\n</body>\r\n</html>".toCharArray();
    _jsp_string9 = "</option>\r\n	".toCharArray();
