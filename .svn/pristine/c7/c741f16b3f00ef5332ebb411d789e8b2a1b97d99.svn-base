...
//Edited by Xuehai, 25 May 2011. Removed 'void' to enable running on Chrome&Firefox
    function validate(form)
    {
      ...
      else 
      {
      	...
      	{
      		iValid = 1;
      		window.document.Top.action = "Top_changeMaintenance.jsp?result=1";
		...
		if(isEnabled == 1)
		{
	    	if(db_password.equals(password))
	    	{
				...
				if(UserDetail[8].equals("Super Administrator"))
				{
					...
					%>
					<jsp:forward page="indexAdminMaintenance.jsp"/>
					<%
				}
				else
				{	%>
...
<TABLE WIDTH=800 BORDER=0 CELLPADDING=0 CELLSPACING=0>
    ...
    <TD COLSPAN=2 background="images/360_09.jpg"><table width="156" border="0" cellpadding="0" cellspacing="0" background="images/360_09.jpg">
        <tr><!-- Edited by Xuehai, 25 May 2011. Enable to run on Chrome&Firefox -->
          ...
          <td width="89"><input type="text" style='width:85px;height:20px;' name="txtUsername" tabindex = 1 onKeyPress="if(event.keyCode==13) { return validate(); }"></td>
        </tr>
      </table> </TD>
		<TD>
	...
	<TR>
		<TD ROWSPAN=4>
			...
			<IMG SRC="images/360_11.jpg"  style="cursor:pointer" ALT="" WIDTH=28 HEIGHT=32 border="0" name="btnLogin" onclick="validate()"></a></TD>
		<TD>
    ...
    <TD COLSPAN=2 ROWSPAN=2 valign="top" background="images/360_12.jpg"><table width="156" border="0" cellpadding="0" cellspacing="0" background="images/360_12.jpg">
        <tr><!-- Edited by Xuehai, 25 May 2011. Enable to run on Chrome&Firefox -->
          ...
          <td width="10"><img src="images/spacer.gif" width="5" height="5"> </td>
          <td width="89"><input type="password" name="txtPass" style='width:85px;height:20px;' tabindex = 2 onKeyPress="if(event.keyCode==13) { return validate(); }"></td>
        </tr>
      </table> </TD>
		<TD>
