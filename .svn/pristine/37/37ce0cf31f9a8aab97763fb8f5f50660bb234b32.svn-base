...
public class _ratingscale__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    CP_Classes.Competency CompQuery;
    synchronized (pageContext.getSession()) {
      CompQuery = (CP_Classes.Competency) pageContext.getSession().getAttribute("CompQuery");
      if (CompQuery == null) {
        CompQuery = new CP_Classes.Competency();
        pageContext.getSession().setAttribute("CompQuery", CompQuery);
      }
    }
...
// Mark Oei 09 Mar 2010 
    ...
    out.print((trans.tslt("Delete Rating Scale")));
    ...
    out.print((trans.tslt("Scale Range")));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("RatingScale.jsp"), 8025503697118563458L, false);
    _caucho_depends.add(depend);
