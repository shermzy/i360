...
public class _report_0nomination__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    CP_Classes.Report_Nomination RptNom;
    synchronized (pageContext.getSession()) {
      RptNom = (CP_Classes.Report_Nomination) pageContext.getSession().getAttribute("RptNom");
      if (RptNom == null) {
        RptNom = new CP_Classes.Report_Nomination();
        pageContext.getSession().setAttribute("RptNom", RptNom);
      }
    }
    out.write(_jsp_string0, 0, _jsp_string0.length);
...
if(request.getParameter("btnPreview") != null)
{
    ...
    out.print((trans.tslt("Nomination Report")));
...
// Mark Oei 09 Mar 2010
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("Report_Nomination.jsp"), 4285359345207201774L, false);
    _caucho_depends.add(depend);
  ...
  static {
    ...
    _jsp_string9 = "</option>\r\n	".toCharArray();
    _jsp_string20 = "\" name=\"btnPreview\" style=\"float: center\" disabled>\r\n".toCharArray();
    _jsp_string10 = "\r\n				<option value=".toCharArray();
    ...
    _jsp_string0 = "\r\n".toCharArray();
    _jsp_string19 = "\" name=\"btnPreview\" style=\"float: center\">\r\n".toCharArray();
