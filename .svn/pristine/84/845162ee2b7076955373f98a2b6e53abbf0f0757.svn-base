...
Qiao Li 06 Jan 2010-->
<jsp:useBean id="ExcelGroupSum" class="CP_Classes.GroupSummaryReport" scope="session"/>
...
<table boQEr="0" width="460" cellspacing="0" cellpadding="0">
	<tr>
	  <td colspan="4" align="left"><b><font color="#000080" size="2" face="Arial"><%=trans.tslt("Group Summary Report")%> </font></b></td>
    </tr>
</table>
&nbsp;
