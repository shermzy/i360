...
Menu2=new Array("<img src = images/360_18.jpg>","","",6, 33, 143);
	...
	Menu2_3=new Array("Development Activities","DevelopmentActivities.jsp","",0);
	Menu2_4=new Array("Development Resources","DevelopmentResources.jsp","",0);
	Menu2_5=new Array("Rating Task","RatingTask.jsp","",0);
	Menu2_6=new Array("Rating Scale","RatingScale.jsp","",0);
	

Menu3=new Array("<img src = images/360_19.jpg>","","",5,33,108);
	Menu3_1=new Array("Create Survey Wizard","SurveyList_Wizard.jsp","",0,20,130);
	Menu3_2=new Array("Create/Edit Survey","SurveyList_Create.jsp","",0);
	Menu3_3=new Array("Assign Target/Rater","SurveyList_AssignTR.jsp","",0);
	Menu3_4=new Array("Rater's Data Entry","RatersDataEntry.jsp","",0);
	Menu3_5=new Array("Process Result","SurveyList_Process.jsp","",0);

Menu4=new Array("<img src = images/360_20.jpg>","","",4,33,89);
	...
	Menu4_4=new Array("Customised Reports","","",5,15,150);
...
Menu5=new Array("<img src = images/360_21.jpg>","","",6,33,87);
