...
Menu2=new Array("<img src = images/360_18.jpg>","","",7, 33, 143);
	...
	Menu2_4=new Array("Development Activity","DevelopmentActivities.jsp","",0);
	Menu2_5=new Array("Development Resource","DevelopmentResources.jsp","",0);
...
Menu4=new Array("<img src = images/360_20.jpg>","","",3,33,89);
	...
	Menu4_2=new Array("Input Reports","","",6,15,150);
		...
		Menu4_2_5=new Array("Rater's Input for Group","Report_RaterInput_Group.jsp","",0);
		Menu4_2_6=new Array("List of Survey Targets","Report_Target_Survey.jsp","",0);
...
Menu5=new Array("<img src = images/360_21.jpg>","","",3,33,87);
	...
	Menu5_1=new Array("Import and Export","ImportExport.jsp","",0, 20, 150);
	Menu5_2=new Array("View Sent Failed Emails","SentFailedEmail.jsp","",0);
	Menu5_3=new Array("Logout","Logout.jsp","",0);
