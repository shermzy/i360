...
public class _adddategroup__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    Coach.CoachDateGroup DateGroup;
    synchronized (pageContext.getSession()) {
      DateGroup = (Coach.CoachDateGroup) pageContext.getSession().getAttribute("DateGroup");
      if (DateGroup == null) {
        DateGroup = new Coach.CoachDateGroup();
        pageContext.getSession().setAttribute("DateGroup", DateGroup);
      }
    }
    out.write(_jsp_string1, 0, _jsp_string1.length);
...
String username=(String)session.getAttribute("username");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("Coach/AddDateGroup.jsp"), 184912556873972720L, false);
    _caucho_depends.add(depend);
  }
