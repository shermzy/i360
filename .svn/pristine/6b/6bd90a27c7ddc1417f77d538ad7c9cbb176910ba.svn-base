...
public class _addslotgroup__jsp extends com.caucho.jsp.JavaPage
{
...
String username=(String)session.getAttribute("username");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("Coach/AddSlotGroup.jsp"), -5052603550239421853L, false);
    _caucho_depends.add(depend);
  }
