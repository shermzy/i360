...
public class _viewvenuedetails__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("Coach/ViewVenueDetails.jsp"), 8619237544314343599L, false);
    _caucho_depends.add(depend);
  }
