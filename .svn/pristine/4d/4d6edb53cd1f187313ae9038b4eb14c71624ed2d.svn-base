...
public class _additionalanswers__jsp extends com.caucho.jsp.JavaPage
{
...
String username=(String)session.getAttribute("username");
  ...
  Vector<AdditionalQuestion> v = AddQController.getQuestions(surveyID);
    ...
    out.print((AddQController.getAnswerHeader(surveyID)));
...
for(int i=0;i<v.size();i++)
{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("AdditionalAnswers.jsp"), 4040467034478170327L, false);
    _caucho_depends.add(depend);
  }
