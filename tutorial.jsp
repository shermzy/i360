...
<table border="0" width="100%" height="402" style="border-left-width: 0px; border-right-width: 2px; border-top-width: 0px; border-bottom-width: 0px">
	...
	<tr>
		...
		<b><font face="Arial" size="2" color="#00FF00">&nbsp; <%=trans.tslt("Step 1: Set-up Demographics")%> &amp; &nbsp;</font>
		<font face="Arial" size="2" color="#00FF00">&nbsp;<br>&nbsp; <%=trans.tslt("Organisations")%></font></b></td>
		<td style="border-left-style: solid; border-left-width: 1px; border-right-style: solid; border-right-width: 1px; border-bottom-style: solid; border-bottom-width: 1px" bordercolor="#3399FF" bgcolor="#647BBB" width="49%" height="20"><b>
		<font face="Arial" size="2" color="#00FF00">&nbsp; <%=trans.tslt("Step 2: Set-up Users")%> 
		&amp; <%=trans.tslt("Jobs")%></font></b></td>
	</tr>
	<tr>
		...
		<blockquote>
			<ol><br>
				...
				<li><font face="Arial" size="2"><a href="AgeRange.jsp"><%=trans.tslt("Age Range")%></a></font></li>
				<li><font face="Arial" size="2"><a href="EthnicGroup.jsp"><%=trans.tslt("Ethnic Group")%></a></font></li>
				<li><font face="Arial" size="2"><a href="Location.jsp"><%=trans.tslt("Location")%></a></font></li>
				...
				<li><font face="Arial" size="2"><a href="TimeFrame.jsp"><%=trans.tslt("Time Frame")%></a></font></li>
			</ol>
		</blockquote>
		</td>
		<td style="border-style: solid; border-width: 1px" bordercolor="#3399FF" width="49%" height="146">
		<blockquote>
			<ol>
	...
	<tr>
		...
		<td style="border-left-style: solid; border-left-width: 1px; border-right-style: solid; border-right-width: 1px; border-bottom-style: solid; border-bottom-width: 1px" bordercolor="#3399FF" bgcolor="#647BBB" width="49%" height="22">&nbsp; <b>
	...
	<tr>
		...
		<td style="border-style: solid; border-width: 1px" bordercolor="#3399FF" width="49%">
		<blockquote>
			<ol>
				<li><font size="2" face="Arial"><a href="SurveyList_Wizard.jsp"><%=trans.tslt("Create Survey")%></a></font></li>
