...
function AssignTarget(form,field)
{
	if(check(field))
	{
		form.action="SurveyList_Process.jsp?assign=1";
		form.method="post";
		form.submit();	 
	}
	else
...
{ 
	form.action="SurveyList_Process.jsp?add=1";
	form.method="post";
	form.submit();
}
...
function survey(form,field)
{
	if(check(field))
	{
		form.action="SurveyList_Process.jsp?survey=1";
		form.method="post";
		form.submit();
	}
	else
...
function process(form,field)
{
	if(check(field))
	{
		form.action="SurveyList_Process.jsp?process=1";
		form.method="post";
		form.submit();
	}
	else
...
{
	form.action="SurveyList_Process.jsp?proceed="+field.value;
	form.method="post";
	form.submit();
}	
...
{
	form.action="SurveyList_Process.jsp?job=1";
	form.method="post";
	form.submit();	
}
...
function copy(form,field)
{
	if(check(field))
	{
		form.action="SurveyList_Process.jsp?copy=1";
		form.method="post";
		form.submit();	
	}
	else
...
function DeleteAway(form,field)
{
	if(check(field))
	{
		...
		{
			form.action="SurveyList_Process.jsp?del=1";
			form.method="post";
			form.submit();	
		}
	}
...
if(request.getParameter("del") != null)
{
	...
	**********************/
	votblSurvey voSurvey = CE_Survey.getSurveyDetail(var1);
		//if(rs_Survey.next())
...
<form name="SurveyList" action="SurveyList_Process.jsp" method="post">
...
<th bgcolor="#000080" width="823"><b><font style='color:white' size="2"><%=trans.tslt("Process Result For Specific Survey")%></font></b></th>
</table>
...
<th width="54%" bgcolor="#000080" style="border-right-style: none; border-right-width: medium" colspan="2"> 
    	...
    	<b><font size="2" style="color: white"><a href="SurveyList_Process.jsp?sorting=1"><font style='color:white'><u><%=trans.tslt("Name")%></u></a></font></b></th>
<font face="Tahoma">
<th width="70" bgcolor="#000080"><b><font style="color: white" size="2"><a href="SurveyList_Process.jsp?sorting=2"><font style='color:white'><u><%=trans.tslt("Opening Date")%></u></a></font></b></th>
<th width="100" bgcolor="#000080"><b><font style='color:white' size="2"><a href="SurveyList_Process.jsp?sorting=3"><font style='color:white'><u><%=trans.tslt("Deadline")%></u></a></font></b></th>
<th width="100" bgcolor="#000080"><b><font style='color:white' size="2"><a href="SurveyList_Process.jsp?sorting=4"><font style='color:white'><u><%=trans.tslt("Closed Date")%></u></a></font></b></th>
<th width="100" bgcolor="#000080"><b><font style='color:white'  size="2"><a href="SurveyList_Process.jsp?sorting=5"><font style='color:white'><u><%=trans.tslt("Status")%></u></a></font></b></th>
<th width="82" bgcolor="#000080">
<span style="font-weight: 400"><b><font size="2" style="color: white"><a href="SurveyList_Process.jsp?sorting=6"><font style='color:white'><u><%=trans.tslt("Organisation")%></u></a></font></b></span></th>
  ...
  <%	
	...
	String SurveyStatus=" ";
	/**************************
	*Edit By James 14-Nov 2007, Last edited by Yuni 20 Nov 2007
	***********************/
		...
		{
		votblSurvey voS=(votblSurvey)rs_SurveyDetail.elementAt(j);
			int Surv_ID = voS.getSurveyID();
			String Surv_Name = voS.getSurveyName();
			DateOpened = voS.getDateOpened();
			DeadlineDate = voS.getDeadlineSubmission();
			db_SurveyStatus = voS.getSurveyStatus();
			String anal_Date = voS.getAnalysisDate();
			String OrganizationName = voS.getOrganizationName();
...
<tr onMouseOver = "this.bgColor = '#99ccff'"
    	onMouseOut = "this.bgColor = '#FFFFFF'">
				<td width="4%" bgcolor="#FFFFCC" style="border-style:solid; border-width:1px; " bordercolor="#3399FF">
				<p align="center">
				<font face="Arial"><span style="font-size: 10pt">
				<font color="#FFC36B" size="3">
				<input type="radio" value=<%=Surv_ID%> name="Survey" ondblclick="process(this.form,this.form.Survey)"></font></span></font></td>
				

				<td width="50%" bgcolor="#FFFFCC" style="border-style:solid; border-width:1px; " bordercolor="#3399FF"><font size="2">&nbsp<%=Surv_Name%></td>
				

    <td align="center" bgcolor="#FFFFCC" style="border-style:solid; border-width:1px; " bordercolor="#3399FF"><font size="2"><%=DateOpened%></td>
    <td align="center" bgcolor="#FFFFCC" style="border-style: solid; border-width: 1px" bordercolor="#3399FF"><font size="2"><%=DeadlineDate%></td>
    <td align="center" bgcolor="#FFFFCC" style="border-style: solid; border-width: 1px" bordercolor="#3399FF"><font size="2"><%=anal_Date%>&nbsp</td>
    <td align="center" bgcolor="#FFFFCC" style="border-style: solid; border-width: 1px" bordercolor="#3399FF"><font size="2"><%=SurveyStatus%></td>
     <td align="center" bgcolor="#FFFFCC" style="border-style: solid; border-width: 1px" bordercolor="#3399FF"><font size="2"><%=OrganizationName%></font></td>
