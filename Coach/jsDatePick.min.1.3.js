g_l=[];g_l.MONTHS=["Janaury","February","March","April","May","June","July","August","September","October","November","December"];
...
JsDatePick=function(a){if(document.all){
	...
	this.isie=false;}this.oConfiguration={};
	this.oCurrentDay=g_currentDateObject;
	this.monthsTextualRepresentation=g_l.MONTHS;
	this.lastPostedDay=null;this.initialZIndex=2;
	...
	JsDatePick.getInternetExplorerVersion=function(){
		...
		{a=Math.floor(Math.random()*1000);}return a;};
		...
		{if(typeof(a)=="function"){this.onSelectedDelegate=a;
		return true;}return false;};JsDatePick.prototype.executeOnSelectedDelegateIfExists=function()
		{if(typeof(this.onSelectedDelegate)=="function"){this.onSelectedDelegate();}
		if(typeof(this.addonSelectedDelegate)=="function")
		{this.addonSelectedDelegate();}};JsDatePick.prototype.setRepopulationDelegate=function(a)
		{if(typeof(a)=="function"){this.repopulationDelegate=a;return true;}
		return false;};JsDatePick.prototype.setConfiguration=function(a)
		...
		this.rightWallStrechedElement.style.height=b+"px";return true;};
		...
		this.closeCalendar();};
		JsDatePick.prototype.makeCalendar=function(){var j=document,e,a,b,k,g,h,f,o,i,m,n,l,c;e=j.createElement("div");
		a=j.createElement("div");b=j.createElement("div");this.setC(e,"JsDatePickBox");
		this.setC(a,"clearfix");this.setC(b,"jsDatePickCloseButton");
		...
		d.setTooltipText(g_l.CLOSE);d.setC(this,"jsDatePickCloseButtonOver");};
		...
		d.setTooltipText(g_l.CLOSE);d.setC(this,"jsDatePickCloseButtonDown");};
		b.onmouseup=function(){var d=JsDatePick.getCalInstanceById(this.getAttribute("globalNumber"));
		d.setTooltipText("");d.setC(this,"jsDatePickCloseButton");
		d.closeCalendar();};
		this.JsDatePickBox=e;k=j.createElement("div");
		g=j.createElement("div");h=j.createElement("div");
		f=j.createElement("div");this.setC(h,"topWall");
		this.setC(f,"bottomWall");
		if(this.isie&&this.iever==6)
		{f.style.bottom="-2px";}
		o=j.createElement("div");
		i=j.createElement("div");m=j.createElement("div");
		this.setC(o,"leftTopCorner");this.setC(i,"leftBottomCorner");
		this.setC(m,"leftWall");this.leftWallStrechedElement=m;
		this.leftWall=k;this.rightWall=g;k.appendChild(o);
		k.appendChild(m);k.appendChild(i);o=j.createElement("div");
		i=j.createElement("div");m=j.createElement("div");
		this.setC(o,"rightTopCorner");this.setC(i,"rightBottomCorner");
		this.setC(m,"rightWall");this.rightWallStrechedElement=m;g.appendChild(o);
		g.appendChild(m);g.appendChild(i);
		...
		e.appendChild(h);
		e.appendChild(f);}if(this.oConfiguration.useMode==2){if(this.oConfiguration.target!=false)
		{if(typeof(JsgetElem(this.oConfiguration.target))!=null)
		{n=JsgetElem(this.oConfiguration.target);
		l=document.createElement("span");
		n.parentNode.replaceChild(l,n);l.appendChild(n);n.setAttribute("globalNumber",this.globalNumber);
		...
		l.style.position="relative";this.initialZIndex++;e.style.zIndex=this.initialZIndex.toString();
		e.style.position="absolute";e.style.top="18px";e.style.left="0px";e.style.display="none";l.appendChild(e);
		...
		else{if(this.oConfiguration.target!=null){JsgetElem(this.oConfiguration.target).appendChild(e);
		JsgetElem(this.oConfiguration.target).style.position="relative";
		e.style.position="absolute";e.style.top="0px";e.style.left="0px";
		this.resizeCalendar();this.executePopulationDelegateIfExists();}
		...
		{this.setSelectedDay({year:parseInt(this.lastPickedDateObject.year),
			month:parseInt(this.lastPickedDateObject.month,10),
			day:parseInt(this.lastPickedDateObject.day,10)});}
		else{b=JsgetElem(this.oConfiguration.target);
