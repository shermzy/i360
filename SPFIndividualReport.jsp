...
<%  } 
	...
	if(request.getParameter("SPFFormat")!=null){
		SPFFormat1 = true;
	}
	if(surveyID != 0)
	{
			...
			if (request.getParameter("targetName") != null)
			{
					...
					else
					{
						if(target != 0)
						{
							...
							if(type == 1 || type == 2)
							{
								...
								ExcelIndividualSPF.Report(surveyID, target, pkUser, file_name, type, chkNormative, chkGroupCPLine, chkSplit, chkBreakCPR, langType, template,weightedAvg,SPFFormat1);
				...
				<%				
									...
									if(type == 1 || type == 2)
									{
										...
										ExcelIndividualSPF.Report(surveyID, targetID, pkUser, file_name, type, chkNormative, chkGroupCPLine, chkSplit, chkBreakCPR, langType, template,weightedAvg,SPFFormat1);									
										// End edit by Tracy****
	...
	<tr>
		...
		<table border="0" width="100%" id="table1">
			...
			<tr>
				...
				<tr>
				<td width="6%">
				<p align="center"><input type="checkbox" name="SPFFormat"></td>
				<td><font size="2">SPF Format</font></td>
			</tr>
		</table>
		</td>
